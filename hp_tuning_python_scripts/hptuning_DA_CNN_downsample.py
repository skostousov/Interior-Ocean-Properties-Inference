...
# filename = 'data/daily_alternative_small/small_daily_alternative_sample_1993-1993.nc'
filename = 'data/monthly/ten_sample_1993-2003.nc'
...
for i, config in enumerate(sampler, start=1):
    ...
    print(f"Trial {i:02d}/{num_samples} | val_loss = {val_loss:.6f} | "
          f"config = {config} | filename = {filename}")
