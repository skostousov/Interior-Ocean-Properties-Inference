...
info_txt_path = model_path / "training_info.txt"
...
info_dict = {k: v for k, v in info_dict.items() if k in ['start_time','data_file', 'test_indices', 'epochs', 'batch_size', 'optimizer', 'loss_fn', 'scheduler', 'best_loss', 'best_epoch', 'corresponding_train_loss', 'train_dataset_size', 'val_dataset_size', 'test_dataset_size']}
print(info_dict.keys())
print(info_dict['data_file'])
print(info_dict['test_indices'])
print(info_dict['loss_fn'])
data_file = project_root / info_dict['data_file']
test_indices_file = project_root / info_dict['test_indices']
...
test_dataloader = torch.utils.data.DataLoader(test_data, batch_size=1, shuffle=False, num_workers=6, pin_memory=True,)
